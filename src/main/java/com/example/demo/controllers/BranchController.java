...
public class BranchController {
    ...
    public String BranchAdd(@ModelAttribute("branch") Branch branch)
    {
        return "branch-add";
    }

    @PostMapping("/branch/add")
    public String BranchAdd(@ModelAttribute("branch")@Valid Branch branch, BindingResult bindingResult)
    {
